...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static OptionItem BaitTaskTrigger;
        ...
        public static void Load()
        {
            ...
            BaitTaskTrigger = IntegerOptionItem.Create(20013, "BaitTaskTrigger", new(0, 20, 1), 1, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Bait]);
            OverrideTasksData.Create(20020, TabGroup.CrewmateRoles, CustomRoles.Bait);
            ...
            Yfox.SetupCustomOption();
            PhantomThief.SetupCustomOption();
        ...
        public static void SetupSingleRoleOptions(int id, TabGroup tab, CustomRoles role, int count, CustomGameMode customGameMode = CustomGameMode.Standard)
        {
            ...
            var countOption = IntegerOptionItem.Create(id + 1, "Maximum", new(1, 15, 1), count, tab, false).SetParent(spawnOption)
                .SetGameMode(customGameMode);
