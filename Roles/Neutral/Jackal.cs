...
namespace TownOfHost.Roles.Neutral
{
    public static class Jackal
    {
        ...
        private static OptionItem JackalCanKillOtherJackal;

        public static void SetupCustomOption()
        {
            //Jackalは1人固定
            SetupSingleRoleOptions(Id, TabGroup.NeutralRoles, CustomRoles.Jackal, 15);
            ...
            JackalCanKillOtherJackal= BooleanOptionItem.Create(Id + 13, "JackalCanKillOtherJackal", true, TabGroup.NeutralRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Jackal]);
        }
